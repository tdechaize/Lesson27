...
#define VER_FILEDESCRIPTION_STR 	"NeHe Lesson27 OpenGL\0"
#define VER_INTERNALNAME_STR 		"Lesson27\0"
...
#define VER_ORIGINALFILENAME_STR 	"Lesson27.exe\0"
// #define VER_PRODUCTNAME_STR 		"Lesson27 OpenGL : Texture mapping on cube in rotation.\0"
